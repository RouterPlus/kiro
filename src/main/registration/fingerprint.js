...
export function newFPContext(identity) {
...
export function resetPerfTiming(ctx) {
    ctx.perfTiming = null;
}
...
export function buildFingerprintData(identity, locationURL, referrer, nowMs, ctx, pageType, eventType, timeOnPage, emailLen, email) {
...
/** 生成加密后的浏览器指纹字符串 */
export function generateFingerprint(identity, locationURL, referrer, ctx, pageType, eventType, timeOnPage, emailLen, email) {
