...
export const DEFAULT_UA = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Edg/148.0.0.0';
export const DEFAULT_SEC_UA = '"Chromium";v="148", "Microsoft Edge";v="148", "Not/A)Brand";v="99"';
/** 生成 4 位随机十六进制 */
function hex4() {
...
/** 生成 GMT 日期字符串 */
export function gmtDate() {
    return new Date().toUTCString();
}
/** 从 URL 中提取查询参数 */
export function extractParam(rawURL, key) {
    try {
...
/** 获取嵌套 map 值 */
export function getNestedMap(data, ...keys) {
    let current = data;
    for (const k of keys) {
...
/** 获取嵌套的 string map */
export function getNestedStringMap(data, key) {
    if (!data)
        return null;
...
export function saveCookies(cookies, headers) {
